...
#
# Downloads event Parquets (42 LOB + 46 flow features) from S3, builds
# event-backtest, runs 45-fold CPCV with 3 parallel folds, uploads JSON report.
#
...
S3_DATA_PREFIX="cloud-runs/event-export-full-20260303T071423Z-9ad1b1de/events-bbo"
AWS_REGION="us-east-1"
SSH_KEY="kenoma-research"
AMI_ID="ami-0f3caa1cf4417e51b"          # Amazon Linux 2023 x86_64
IAM_PROFILE="cloud-run-ec2"
INSTANCE_TYPE="r7a.4xlarge"              # 16 vCPU, 128 GB RAM (memory-optimized)
...
# Force glibc to use mmap for allocations > 64KB so they're returned to OS on free.
# Prevents memory fragmentation from Parquet reader's many small allocations.
